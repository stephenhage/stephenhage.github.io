...
makeplots(history)
```
![model1](../images/hmnist/model1.png)
...
makeplots(history)
```
![model2](../images/hmnist/model2.png)
...
loss, accuracy = model.evaluate(x_test, y_test, verbose = 1)
```
![model3](../images/hmnist/model3.png)
...
### skinimages
![sample skin lesion images NSFW](../images/hmnist/hmnist_imgs.png)